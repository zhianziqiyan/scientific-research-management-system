...
namespace 科研管理系统
{
    public partial class 项目 : UIForm
    {
        public 项目()
        {
            InitializeComponent();
        ...
        {
            string returnValue = Microsoft.VisualBasic.Interaction.InputBox("输入要删除的项目的项目号");
            if (returnValue != "")
            {
                Dao dao = new Dao();
                string sql = $"delete from project where id ='{returnValue}'";
        ...
        private void toolStripMenuItem4_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Rows.Clear();
            Dao dao = new Dao();
            string sql = $"select * from project where id='{returnValue}' ";
            MySqlDataReader reader = dao.Read(sql);
            while (reader.Read())
            {
                dataGridView1.Rows.Add(
        ...
        private void toolStripMenuItem5_Click(object sender, EventArgs e)
        {
            ...
            if (returnValue != "")
            {
                try
                {
                    ...
                    修改项目 modify = new 修改项目(a1, a2, a3, a4, a5, a6, a7);
                    modify.ShowDialog();
                    reader.Close();
                    dao.DaoClose();
                }
